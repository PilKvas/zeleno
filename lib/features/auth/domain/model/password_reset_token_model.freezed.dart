...
part of 'password_reset_token_model.dart';
...
/// @nodoc
mixin _$PasswordResetTokenModel {
  String get token => throw _privateConstructorUsedError;

  /// Serializes this PasswordResetTokenModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of PasswordResetTokenModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PasswordResetTokenModelCopyWith<PasswordResetTokenModel> get copyWith =>
...
/// @nodoc
@JsonSerializable()
class _$PasswordResetTokenModelImpl implements _PasswordResetTokenModel {
  const _$PasswordResetTokenModelImpl({required this.token});

  factory _$PasswordResetTokenModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$PasswordResetTokenModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PasswordResetTokenModelImpl &&
...
abstract class _PasswordResetTokenModel implements PasswordResetTokenModel {
  const factory _PasswordResetTokenModel({required final String token}) =
      _$PasswordResetTokenModelImpl;

  factory _PasswordResetTokenModel.fromJson(Map<String, dynamic> json) =
      _$PasswordResetTokenModelImpl.fromJson;
