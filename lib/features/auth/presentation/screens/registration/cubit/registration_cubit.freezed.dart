...
class _$RegistrationInitialImpl extends RegistrationInitial {
  const _$RegistrationInitialImpl() : super._();
...
abstract class RegistrationInitial extends RegistrationState {
  ...
  const RegistrationInitial._() : super._();
}
...
class _$RegistrationLoadingImpl extends RegistrationLoading {
  const _$RegistrationLoadingImpl() : super._();
...
class _$RegistrationSuccessImpl extends RegistrationSuccess {
  const _$RegistrationSuccessImpl() : super._();
...
class __$$RegistrationFailureImplCopyWithImpl<$Res>
  ...
  $Res call({Object? error = null}) {
    return _then(
      _$RegistrationFailureImpl(null == error ? _value.error : error),
    );
  }
}
...
class _$RegistrationFailureImpl extends RegistrationFailure {
  const _$RegistrationFailureImpl(this.error) : super._();
...
abstract class RegistrationFailure extends RegistrationState {
  const factory RegistrationFailure(final Object error) =
      _$RegistrationFailureImpl;
  const RegistrationFailure._() : super._();
