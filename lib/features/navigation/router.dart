    ...
    AutoRoute(
      ...
      children: [
        AutoRoute(
          ...
          children: [
            AutoRoute(initial: true, page: GardenPlantsListRoute.page),
        ...
        AutoRoute(
          ...
          children: [
            AutoRoute(initial: true, page: PlantsSearchRoute.page),
            AutoRoute(page: GardenPlantDetailRoute.page),
            AutoRoute(page: PlantRoomsSelectionRoute.page),
            AutoRoute(page: AddGardenPlantRoute.page),
            AutoRoute(page: AddGardenPlantSuccessRoute.page),
          ],
        ),
        AutoRoute(
          ...
          children: [
            ...
            AutoRoute(page: PasswordResetRequestRoute.page),
            AutoRoute(page: PasswordResetVerifyRoute.page),
            AutoRoute(page: PasswordResetConfirmRoute.page),
            AutoRoute(page: ProfileRoute.page, type: _noTransition),
          ],
        ),
      ],
    ),
